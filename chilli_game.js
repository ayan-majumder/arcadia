var sprite,group,cursors,timer,game_music;
var total=1;
var count=0;
var Game1={
preload: function() {

    game.load.image('chomper', 'assets/Untitled-2.png');
...
create:function() {
    ...
    sprite = game.add.sprite(32, 200, 'chomper');
